...
func gswNothingWorker(gg *SimpleGraph, seedHash map[uint64][]uint64, seedLen int, stepSize int, incomingFastqs <-chan *fastq.FastqBig, outgoingSams chan<- *sam.
	SamAln, wg *sync.WaitGroup) {
	var curr *sam.SamAln
