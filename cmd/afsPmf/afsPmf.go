...
func afsPmf(vcfFile string, outFile string, s popgen.McmcSettings) {
	g, err := popgen.VcfToAfs(vcfFile, s) //VcfToAfs is written in terms of polarized, so this is inverted here.
