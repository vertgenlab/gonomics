...
func matchMafPass(assembly_species1 string, assembly_species2 string, chrom_species1 string, chrom_species2 string, species1_SrcSize int, species2_SrcSize int, species1_ChromStart int, species1_ChromEnd int, species2_ChromStart int, species2_ChromEnd int) bool {
	...
	fmt.Printf("step helper: matchMafPass. species 2. ChromStart: %v. diagonal lower bound: %v. diagonal upper bound: %v.\n", float64(species2_ChromStart), float64(species1_ChromStart)-0.05*float64(species1_SrcSize), float64(species1_ChromStart)+0.05*float64(species1_SrcSize)) //TODO: delete after debugging
	fmt.Printf("step helper: matchMafPass. species 1. ChromStart: %v. diagonal lower bound: %v. diagonal upper bound: %v.\n", float64(species1_ChromStart), float64(species2_ChromStart)-0.05*float64(species2_SrcSize), float64(species2_ChromStart)+0.05*float64(species2_SrcSize)) //TODO: delete after debugging
	fmt.Printf("step helper: matchMafPass. pass: %v.\n", pass) //TODO: delete after debugging
