...
var visualizeTests = []struct {
	...
	OutDir: "testdata/test_visualise_normalized_output_1.txt",
	Start: 0,
	End: 13,
	SigFigs: 2,
	DecimalPlaces: 5,
	...
	{InFile: "testdata/test_visualize_normalized_input_1.pfa",
	OutDir: "testdata/test_visualise_normalized_output_2.txt",
	Start: 0,
	End: -1,
	SigFigs: 2,
	DecimalPlaces: 5,
	...
	Chrom: "chr1",
	EndOfAlignment: true,
	ExpectedFile: "testdata/test_visualize_normalized_expected_2.txt",
	},
}
		...
		pFasta.PFasta{Name: "chr2",
			Seq: []pDna.Float32Base{
				pDna.Float32Base{
					...
					G: 0.3,
					T: 0.4}}},
		pFasta.PFasta{Name: "chr1butrllllllylong",
			Seq: []pDna.Float32Base{
				pDna.Float32Base{
					A: 0.23857,
					C: 0.3323,
