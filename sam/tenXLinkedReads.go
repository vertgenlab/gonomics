...
func BarcodeInfoMap(samfile Aln) map[string]*giraf.Note {
...
func LinkedReadsBarcode(samLine Aln) string {
...
func switchBxTag(samLine Aln) Aln {
...
func BxTagWorker(reader <-chan Aln, writer chan<- Aln, wg *sync.WaitGroup) {
