...
var ZeroTruncatedNegativeBinomialTests = []struct {
	...
	{
		InFile:       "testdata/nonZeroVariates.1.0.4.10000.txt",
		R:            1.0,
		P:            0.4,
		LearningRate: 1e-6,
		Delta:        0.001,
	...
	{
		InFile:       "testdata/nonZeroVariates.2.0.1.10000.txt",
		R:            2,
		P:            0.1,
		LearningRate: 1e-6,
		Delta:        0.001,
	...
	{
		InFile:       "testdata/nonZeroVariates.2.0.4.10000.txt",
		R:            2,
		P:            0.4,
		LearningRate: 1e-6,
		Delta:        0.001,
	...
	{
		InFile:       "testdata/nonZeroVariates.6.0.4.10000.txt",
		R:            6,
		P:            0.4,
		LearningRate: 1e-6,
		Delta:        0.001,
	...
	{
		InFile:       "testdata/nonZeroVariates.2.0.1.500000.txt",
		R:            6,
		P:            0.4,
		LearningRate: 1e-6,
		Delta:        0.001,
...
func TestZeroTruncatedNegativeBinomial(t *testing.T) {
	...
	for _, v := range ZeroTruncatedNegativeBinomialTests {
		records = fileio.Read(v.InFile)
		for i := range records {
			currK = parse.StringToInt(records[i])
		...
		currLossPlot = plotLossSurfaceZTNB(countSlice, 0.1, 10, 0.1, 0.01, 0.99, 0.01)
		...
		currR, currP = ZeroTruncatedNegativeBinomial(countSlice, v.LearningRate, v.Delta, v.Epsilon)
		if currR != v.R {
