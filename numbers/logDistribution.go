...
//BinomialDistKnownCoefficient calculates the binomial distribution mass in log space for a particular n,k, and p if the coefficient is already known and passed as an argument.
