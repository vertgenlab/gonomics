...
func TestMeltingTemp(t *testing.T) {
	var testSeqs [][]Base = [][]Base{StringToBases("ATCGTGACTGA"), StringToBases("GTCGTGATTCTGC"), StringToBases("GTCGTTAGATTCTGT")}
	var expectedTm []float64 = []float64{32.4608090067, 41.6641715041, 41.0485726487}
