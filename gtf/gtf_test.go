...
var e2 Exon = Exon{Start: 173487735, End: 173487860, Score: -1, ExonNumber: "\"5\"", ExonID: "\"NM_004905.5\"", Cds: &c2, ThreeUtr: &t}
...
var g map[string]*Gene = map[string]*Gene{"\"PRDX6\"": &g1}//, &g2}
