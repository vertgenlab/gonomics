...
var BedStructTests = []struct {
	...
	{bed: Bed{Chrom: "chr12", ChromStart: 12, ChromEnd: 16, Name: "", Score: 0, Strand: Positive}, chrom: "chr12", chromStart: 11, chromEnd: 16},
}
