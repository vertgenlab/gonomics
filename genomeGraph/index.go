...
func seedCouldBeBetter(seedLen int, currBestScore int, perfectScore int, queryLen int, maxMatch int, minMatch int, leastSevereMismatch int, leastSevereMatchMismatchChange int) bool {
